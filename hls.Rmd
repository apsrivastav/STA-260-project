...
```{r}
par(mfrow=c(3,3))
barplot(table(fdata$BYFCOMP), main = "BYFCOMP")
barplot(table(fdata$BYSIBHOM), main = "BYSIBHOM")
barplot(table(fdata$BYPARED), main = "BYPARED")
barplot(table(fdata$BYINCOME), main = "BYINCOME")
#barplot(table(fdata$BYGRDPRT), main = "BYGRDPRT")
barplot(table(fdata$BYNONUSG), main = "BYNONUSG")
barplot(table(fdata$BYWRKHRS), main = "BYWRKHRS")
barplot(table(fdata$BYTEHDEG), main = "BYTEHDEG")
barplot(table(fdata$BYTMHDEG), main = "BYTMHDEG")
barplot(table(fdata$BYREGION), main = "BYREGION")
par(mfrow=c(2,3))
hist(fdata$BYTXRSTD, main = "BYTXRSTD")
hist(fdata$BYTXMSTD, main = "BYTXMSTD")
hist(fdata$BYACTCTL, main = "BYACTCTL")
hist(fdata$BYSTPREP, main = "BYSTPREP")
hist(fdata$BYWRTNGA, main = "BYWRTNGA")
...
mod3<-lm(BYTXMSTD~BYMSEXMTCH+BYSTLANG+BYFCOMP+BYSIBHOM+BYPARED+BYINCOME+BYGRDRPT+BYNONUSG+BYSCHPRG+BYTXACC+BYACTCTL+BYSTPREP+BYHMWRK+BYWRKHRS+BYTMHDEG+BYSCTRL+BYURBAN+BYREGION+BYAPIB+BYMRCEMTCH+BYMSEXMTCH+BYPARASP*BYSTEXP,data = fdata, na.action = na.omit)
vif(mod3)
summary(mod3)

mod4<-lm(BYTXRSTD~BYESEXMTCH+BYSTLANG+BYFCOMP+BYSIBHOM+BYPARED+BYINCOME+BYGRDRPT+BYNONUSG+BYSCHPRG+BYTXACC+BYACTCTL+BYSTPREP+BYHMWRK+BYWRKHRS+BYTEHDEG+BYSCTRL+BYURBAN+BYREGION+BYAPIB+BYERCEMTCH+BYESEXMTCH+BYWRTNGA+BYPARASP*BYSTEXP,data = fdata, na.action = na.omit)
vif(mod4)
summary(mod4)
```
